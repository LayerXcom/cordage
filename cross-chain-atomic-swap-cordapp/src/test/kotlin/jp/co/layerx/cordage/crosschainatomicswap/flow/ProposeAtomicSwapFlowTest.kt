...
class ProposeAtomicSwapFlowTest {
    ...
    fun `normal scenario`() {
        ...
        Assertions.assertThat(actualProposalState.quantity == expectedSecurityAmount)
        Assertions.assertThat(actualProposalState.priceWei == expectedWeiAmount.toBigInteger())
